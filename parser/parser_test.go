...
func TestIdetifierExpression(t *testing.T) {
	input := "foobar;"
	...
	if !ok {
		t.Fatalf("exp is not an Identifier. got=%T", stmt.Expression)
	}
...
func TestIntegerLiteralExpression(t *testing.T) {
	...
	if literal.TokenLiteral() != "5" {
		t.Errorf("literal.TokenLietral is not %s. got=%s", "5", literal.TokenLiteral())
	}
}
